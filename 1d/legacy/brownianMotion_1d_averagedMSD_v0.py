# Statistics of 1d Random Walk (Square Lattice model)
...
for i in range (M):
    ...
    x_array = brw.coordinateList2xyList(coordinate_list, N)
...
savefile = "./png/Brownian_Motion_1d_averagedMSD_{0}steps_{1}repetition".format(N, M)
