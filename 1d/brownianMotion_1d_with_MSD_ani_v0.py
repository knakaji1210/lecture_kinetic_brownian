...
d2_array, d2_array_steps = brw.dist2FromOrigin(x_list, N)

fig_title1 = "1-dimensional Random Walk ($N$ = {0})".format(N)
fig_title2 = "$d^{{2}}$ vs $t$"
...
savefile = "./gif/Brownian_Motion_1d_{0}steps_with_MSD_ani.gif".format(N)
