# Statistics of 3d Random Walk (Cube Lattice model)
# 260401 2dをベースに3dに拡張
...
for i in range (M):
    ...
    x_array, y_array, z_array = brw.coordinateList2xyzList(coordinate_list, N)
    d2_array, d2_array_steps = brw.dist2FromOrigin(x_array, y_array, z_array, N)
...
# Theoretically <x^2> = 6Dt = t since D = 1/6
